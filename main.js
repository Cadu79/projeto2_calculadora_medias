...
const imgAprovado = '<img src="./IMG/Imagens/images/aprovado.png" alt="Emoji festejando" />';
const imgReprovado = '<img src="./IMG/Imagens/images/reprovado.png" alt="Emoji decpcionado" />';
const atividades = [];
const notas = [];
